...
export const Donate = (props) => {
  ...
  const onClickHandler = async (e) => {
    ...
    const res = await axios({
      method: "post",
      url: "http://localhost:2000/api/event/create",
      data: form,
    ...
    <div className="bg">
      ...
      <div className="formbody" style={{ marginTop: "60px" }}>
        ...
        <Form>
            ...
            <Row>
              <Col>
                <Form.Group className="mb-2">
                  ...
                  <Form.Control type="text" placeholder="City" onChange={(e) => setdistrict(e.target.value)} />
                </Form.Group>
              </Col>
              <Col>
                <Form.Group className="mb-2">
                  <Form.Label className="bold">Postal Code :</Form.Label>
                  <Form.Control type="number" placeholder="Postal Code" onChange={(e) => setpostalCode(e.target.value)} />
                </Form.Group>
              </Col>
            </Row>
            <Row>
              ...
              <Col lg="6">
                <Form.Group className="mb-2">
                  <Form.Label className="bold">Product Image : </Form.Label> <br />
                  {image.length > 0 ? image.map((pic, index) => <div key={index}>{pic.name}</div>) : null}
                  <Form.Control
                    type="file"
          ...
          <br />
          <Button variant="warning" className="abtn" type="submit" onClick={onClickHandler}>
            Upload
          </Button>
        </Form>
      </div>

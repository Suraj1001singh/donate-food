...
export const Signup = (props) => {
  ...
  const onClickHandler = async (e) => {
    ...
    const res=await axios({
      method: 'post',
      url: 'http://localhost:2000/api/userSignup',
      data: payload
    });
      ...
      <div className="formbody" style={{ width: "40%", marginTop: "90px" }}>
        ...
        <Form>
          ...
          <Form.Group className="mb-3">
            ...
            <Form.Control type="tel" placeholder="Enter your Phone Number" required onChange={(e) => setPhone(e.target.value)} />
          </Form.Group>
          <Form.Group className="mb-2">
            <Form.Label className="bold">Password:</Form.Label>
            <Form.Control type="password" placeholder="Password" required min="6" onChange={(e) => setPassword(e.target.value)} />
          </Form.Group>
          <br />
          <div
            className="pb-3"
          ...
          >
            <Button variant="warning" type="submit" className="abtn" style={{ marginLeft: "5px" }} onClick={onClickHandler}>
              Signup
            </Button>
